...
<body>
    ...
    <div id="rest">
     ...
     <textarea rows="2" cols="20" value="<?php echo $_POST['name']; ?>" style="background-color:black;"></textarea>

     <select name="model"  id="model">
         <option value="<?php echo $_POST['model']; ?>"><?php echo $_POST['model']; ?></option>
         <option value="Tesla Model Y">Tesla Model Y</option>
         <option value="Tesla Model Z">Tesla Model Z</option>
     ...
     <select name="payment" id="pay">
         <option value="<?php echo $_POST['payment']; ?>"><?php echo $_POST['payment']; ?></option>
     ...
     <button type="submit" name="update" id="formbutton">BOOK NOW</button>
            </form>
        </div>
        </div>
    </div>
...
global $connection;
   ...
   $query = "UPDATE book_now SET Name='$Name', Model='$Model', Color='$Color', Payment_Type='$Payment'"; 
